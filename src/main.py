import flet as ft
from flet import FilePicker  # <--- السر هنا: إجبار السيرفر على دمج مكتبة الكاميرا/الملفات
import qrcode
import base64
import csv
import requests
...
def main(page: ft.Page):
    ...
    # استخدام الأداة بالاسم الصريح لتجنب الحذف أثناء البناء
    qr_picker = FilePicker()
